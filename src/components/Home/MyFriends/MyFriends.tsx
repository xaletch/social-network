    ...
    <div className='w-[280px] h-[315px] bg-white rounded-xl'>
        <div className='p-5 h-full'>
            ...
            <div className='mt-6 w-full relative'>
              ...
              <input className='w-full p-2 px-8 focus input-shadow outline-none rounded-lg text-sm text-color-text2' type="text" value={searchFriend} onChange={changeSearch} placeholder='Найти друзей' />
              {searchFriend && (
